...
if($version<2038){
	...
	$updateAdminPwd = random(12);
	$updateAdminPayPwd = random(8, 1);
	...
	$sqls[]="REPLACE INTO `pay_config` VALUES ('admin_pwd', '".$updateAdminPwd."')";
	$sqls[]="REPLACE INTO `pay_config` VALUES ('admin_paypwd', '".$updateAdminPayPwd."')";
...
if($updateAdminPwd){
	echo '已生成新的后台密码：admin / '.htmlspecialchars($updateAdminPwd).'<br/>';
	echo '已生成新的支付密码：'.htmlspecialchars($updateAdminPayPwd).'<br/>';
}
if($errorMsg){
