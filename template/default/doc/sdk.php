...
<head>
    ...
    <!-- layui -->
    <link rel="stylesheet" href="<?php echo $cdnpublic?>layui/2.6.8/css/layui.css" />
    <script src="<?php echo $cdnpublic?>layui/2.6.8/layui.js"></script>
    <!-- zTree -->
    ...
    <div id="body">
        <div id="content_body" name="content_body" style="width:100%;height:100%;border:none;overflow: auto;">
            <div id="article-content" class="markdown-body">
                ...
                <h1 id="SDK下载"><a href="#SDK下载">SDK下载</a></h1><h3 id="PHP-SDK"><a href="#PHP-SDK">PHP-SDK</a></h3><p><strong>推荐下载（当前主版本）</strong></p><p><a href="/assets/files/SDK_2.0.zip">SDK_2.0.zip</a></p><p>版本：<code>V2.0</code>（签名模式 / 新接口）</p><hr><p><strong>旧版兼容</strong></p><p><a href="/assets/files/SDK.zip">SDK.zip</a></p><p>版本：<code>V1.3</code>（兼容旧版接入，已做签名模式升级）</p>            <div id="mask" style="display:none" onclick="clickMask()"></div>
            </div>
        </div>
    </div>
