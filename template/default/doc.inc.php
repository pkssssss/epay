...
<p>URL地址：<font color="#29389f"><?php echo $siteurl?>api.php?act=query&amp;pid={商户ID}&amp;timestamp={时间戳}&amp;sign={签名}&amp;sign_type=MD5</font></p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
  ...
  <tr><td>商户ID</td><td>pid</td><td>是</td><td>Int</td><td>1001</td><td></td></tr>
  <tr><td>时间戳</td><td>timestamp</td><td>是</td><td>String</td><td>1721206072</td><td>10位秒级时间戳</td></tr>
  <tr><td>签名类型</td><td>sign_type</td><td>是</td><td>String</td><td>MD5</td><td>默认为MD5，也支持RSA</td></tr>
  <tr><td>签名</td><td>sign</td><td>是</td><td>String</td><td>abcdef123456</td><td>按接口参数签名规则生成</td></tr>
  </tbody>
</table>
<p>返回结果：</p>
<table class="table table-bordered table-hover">
...
<p>URL地址：<font color="#29389f"><?php echo $siteurl?>api.php?act=settle&amp;pid={商户ID}&amp;timestamp={时间戳}&amp;sign={签名}&amp;sign_type=MD5</font></p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<p>URL地址：<font color="#29389f"><?php echo $siteurl?>api.php?act=order&amp;pid={商户ID}&amp;out_trade_no={商户订单号}&amp;timestamp={时间戳}&amp;sign={签名}&amp;sign_type=MD5</font></p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<p>URL地址：<font color="#29389f"><?php echo $siteurl?>api.php?act=orders&amp;pid={商户ID}&amp;timestamp={时间戳}&amp;sign={签名}&amp;sign_type=MD5</font></p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<p><font color="#993939">注：trade_no、out_trade_no 不能同时为空，如果都传了以trade_no为准；旧 act 查询/退款接口现已升级为签名模式。</font></p>
<p>返回结果：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<blockquote>
<p><b>推荐下载（当前主版本）</b></p>
<p><a href="./assets/files/SDK_2.0.zip?_v=2.0" style="color:blue">SDK_2.0.zip</a><br/>SDK版本：V2.0（签名模式 / 新接口）</p>
<hr style="margin:10px 0;">
<p><b>旧版兼容</b></p>
<p><a href="./assets/files/SDK.zip?_v=1.3" style="color:blue">SDK.zip</a><br/>SDK版本：V1.3（兼容旧版接入，已做签名模式升级）</p>
</blockquote>
		</div>
