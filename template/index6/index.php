        ...
        <div id="header" class="header navbar navbar-transparent navbar-fixed-top">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a href="index.html" class="navbar-brand" aria-label="首页"></a>
                </div>
                <!-- end navbar-header -->
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="service">
                            ...
                            <div class="info">
                                ...
                                <p class="desc">结算费率低至<?php echo $conf['settle_rate']; ?>%，每日满<?php echo $conf['settle_money']; ?>元自动结算，上不封顶，提现手续费最低<?php echo $conf['settle_fee_min']; ?>元，最高<?php echo $conf['settle_fee_max']; ?>元。</p>
                            </div>
                        </div>
                    </div>
                    <!-- end col-3 -->
