        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu animated fadeInRight w">
              ...
              <li class="divider"></li>
              <li>
                <a ui-sref="access.signin" href="javascript:submitLogout()">退出登录</a>
              </li>
            </ul>
            <!-- / dropdown -->
          </li>
      ...
      <div class="aside-wrap">
        ...
        <?php if($conf['complain_open']==1){?>
              <li class="<?php echo checkIfActive('complain,complain_info')?>">
                <a href="complain.php">
                  <?php $complain_total = $DB->getColumn("SELECT count(*) from pre_complain WHERE uid=:uid AND status=0", [':uid'=>$uid]); if($complain_total>0){echo '<b class="label bg-danger pull-right">'.$complain_total.'</b>';}?>
