...
function loginUser(uid){
	if(!window.CSRF_TOKEN){
		layer.alert('CSRF TOKEN ERROR', {icon:2});
		return;
	}
	var form = $('<form>', {method:'POST', action:'./sso.php', target:'_blank'});
